...
public class FPSTileService extends TileService {
  ...
  public void onStartListening() {
      ...
      for (ActivityManager.RunningServiceInfo service :
          ...
          if (org.neoteric.device.DeviceExtras.FPSInfoService.class.getName().equals(
  ...
  @Override
  public void onClick() {
      Intent fpsinfo = new Intent(this, org.neoteric.device.DeviceExtras.FPSInfoService.class);
      if (!isShowing)
