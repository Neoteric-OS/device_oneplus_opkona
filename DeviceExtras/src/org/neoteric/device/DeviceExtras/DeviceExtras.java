...
import org.neoteric.device.DeviceExtras.doze.DozeSettingsActivity;
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
         if (preference == mHBMModeSwitch) {
            ...
            Intent hbmIntent = new Intent(this.getContext(),
                    org.neoteric.device.DeviceExtras.HBMModeService.class);
            if (enabled) {
            ...
            Intent fpsinfo = new Intent(this.getContext(),
                    org.neoteric.device.DeviceExtras.FPSInfoService.class);
            if (enabled) {
